...
--
-- Host: localhost
-- Generation Time: Nov 29, 2020 at 06:51 AM
...
--
ALTER TABLE `Housekeeper`
  ADD CONSTRAINT `AEmail` FOREIGN KEY (`A_Email`) REFERENCES `Admin` (`Email`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `IEmail` FOREIGN KEY (`I_Email`) REFERENCES `Individual` (`Email`) ON DELETE CASCADE ON UPDATE CASCADE;
